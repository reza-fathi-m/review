...
import {CircleCheck, CircleX, Pencil, Plus, Trash, UserRound, UsersRound} from "lucide-react";
import React, {useEffect, useState} from "react";
import {SportForm} from "@/app/(site)/sports/sport-form";
                            ...
                            <TableBody>
                                {sports?.map((sport, index) => (
                                    <TableRow key={sport.id}>
                                        ...
                                        <TableCell>{sport.singular ? <span
                                                className={'inline-flex flex-row-reverse items-center gap-x-2'}>فردی <UserRound/></span> :
                                            <span
                                                className={'inline-flex flex-row-reverse items-center gap-x-2'}>گروهی <UsersRound/></span>}</TableCell>
                                        <TableCell>{sport.has_leage ? <CircleCheck className={'text-emerald-500'}/> :
                                            <CircleX className={'text-red-600'}/>}</TableCell>
                                        <TableCell>
                                            <Button
                                                size="icon"
